...
const SIGNATURE_MOVESETS = {
  ...
  6: ["flamethrower", "airSlash", "dragonClaw", "scaleShot"],
  ...
  142: ["stoneEdge", "rockBlast", "airSlash", "dragonClaw"],
  ...
  149: ["outrage", "scaleShot", "dragonDance", "dragonClaw"],
  150: ["psychic", "shadowBall", "recover", "darkPulse"],
  151: ["psychic", "energyBall", "thunderWave", "recover"],

  154: ["energyBall", "bulletSeed", "synthesis", "sleepPowder"],
  ...
  169: ["airSlash", "poisonJab", "crunch", "hypnosis"],
  ...
  208: ["ironHead", "earthquake", "rockBlast", "ironDefense"],
  ...
  248: ["crunch", "stoneEdge", "rockBlast", "dragonDance"],
